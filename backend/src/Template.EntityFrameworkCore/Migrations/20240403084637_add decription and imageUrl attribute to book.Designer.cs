...
namespace Template.Migrations
{
    ...
    [Migration("20240403084637_add decription and imageUrl attribute to book")]
    partial class adddecriptionandimageUrlattributetobook
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Template.Domain.Model.Book", b =>
                {
                    ...
                    b.Property<int>("Number_Avaliable")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Template.Domain.Model.Comment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Template.Domain.Model.OutBook", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Template.Domain.Model.Comment", b =>
                {
                    b.HasOne("Template.Domain.Model.Book", "Book")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("Template.Domain.Model.OutBook", b =>
                {
                    ...
                    b.HasOne("Template.Domain.Model.Borrower", "Borrower")
                        .WithMany()
